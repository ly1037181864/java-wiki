...
-Dcom.sun.management.jmxremote.access.file=/home/tomcat/tomcats/tomcat_scorpius1/conf/jmxremote.access 
-Dcom.sun.management.jmxremote.password.file=/home/tomcat/tomcats/tomcat_scorpius1/conf/jmxremote.password 
-Djava.rmi.server.hostname=10.26.2.150
```
```text
jmxmonitor    readonly
...
```
```text
jmxmonitor   xiaoanoa#20181212
monitorRole  xiaoanoatimes#20181219
controlRole  xiaoanoatimes#20181219
```
...
参考文档:https://mp.weixin.qq.com/s?__biz=MzI4NDY5Mjc1Mg==&mid=2247484023&idx=1&sn=39be119fdf3132240adc84a85bf8a054&chksm=ebf6da08dc81531e3719389555150f2d0237554b6b6c07a123efdea7c78c0ae2f064cc577bd4&scene=21#wechat_redirect
